...
#include "EnvQueryGenerator_MyCovers.h"
...
UEnvQueryGenerator_MyCovers::UEnvQueryGenerator_MyCovers() {
...
void UEnvQueryGenerator_MyCovers::GenerateItems(FEnvQueryInstance& QueryInstance) const {
...
FText UEnvQueryGenerator_MyCovers::GetDescriptionTitle() const {
...
FText UEnvQueryGenerator_MyCovers::GetDescriptionDetails() const {
...
void UEnvQueryGenerator_MyCovers::FilterCovers(TArray<FCover>& InOut) const {
